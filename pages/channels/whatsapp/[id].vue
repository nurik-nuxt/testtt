  ...
  <div class="grid">
    <div class="col-12">
      <div class="card">
        ...
        <div v-if="!authorized" class="flex">
          <div class="flex flex-column gap-3" style="width: 50%">
        ...
        <div v-if="authorized" class="flex flex-column gap-4">
          ...
          <div class="flex flex-column gap-2 mt-3">
            ...
            <Button :label="t('save')" @click="changeChannel" :disabled="!channelTitle?.length" style="width: 50%"></Button>
          </div>
        </div>
      </div>
    </div>
